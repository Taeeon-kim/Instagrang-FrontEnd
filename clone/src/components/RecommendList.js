    ...
    return(
        <React.Fragment>
          <Grid  margin="0px 0px 0px -100px">
            ...
            <Grid is_fix is_flex height ="70px" top ="100px" width="400px">
             ...
             <Grid is_fix is_flex height ="20px" top ="180px" width="400px">
            ...
            {/* 여기부분을 맵핑돌리면 될거같다 */}
            <Grid padding="0px 8px" is_fix is_flex height ="70px" top ="200px" width="400px">
             ...
             <Grid padding="0px 8px" is_fix is_flex height ="70px" top ="270px" width="400px">
             ...
             <Grid padding="0px 8px" is_fix is_flex height ="70px" top ="340px" width="400px">
                 <Image  cursor='pointer' src={props.src} imageType="circle" size="42" src="https://img.insight.co.kr/static/2020/08/26/700/9q3e4k3731j1y60xqfg0.jpg"/>
                 <Grid width="210px" height="70px">
                     <Text margin="20px 0px 5px 5px" bold width="220px" height="20px" size="14px">유저닉네임 </Text>
                     <Text  margin="0px 0px 0px 5px" width="220px" height="20px" color="#8E8E8E" size="14px">instagram 신규 가입 </Text>
             ...
             <Grid padding="0px 8px" is_fix is_flex height ="70px" top ="410px" width="400px">
                 <Image  cursor='pointer' src={props.src} imageType="circle" size="42" src="https://img.insight.co.kr/static/2020/08/26/700/9q3e4k3731j1y60xqfg0.jpg"/>
                 <Grid width="210px" height="70px">
                     <Text margin="20px 0px 5px 5px" bold width="220px" height="20px" size="14px">유저닉네임 </Text>
                     <Text  margin="0px 0px 0px 5px" width="220px" height="20px" color="#8E8E8E" size="14px">instagram 신규 가입 </Text>
             ...
             <Grid padding="0px 8px" is_fix is_flex height ="70px" top ="480px" width="400px">
                 <Image  cursor='pointer' src={props.src} imageType="circle" size="42" src="https://img.insight.co.kr/static/2020/08/26/700/9q3e4k3731j1y60xqfg0.jpg"/>
                 <Grid width="210px" height="70px">
                     <Text margin="20px 0px 5px 5px" bold width="220px" height="20px" size="14px">유저닉네임 </Text>
                     <Text  margin="0px 0px 0px 5px" width="220px" height="20px" color="#8E8E8E" size="14px">instagram 신규 가입 </Text>
